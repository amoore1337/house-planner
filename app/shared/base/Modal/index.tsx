    ...
    return (
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className={clsx(
            props.className,
            "overflow-auto rounded border-2 border-solid border-green-600",
            "fixed top-1/2 left-1/2 max-h-[90vh] min-w-[300px] -translate-x-1/2 -translate-y-1/2 bg-white md:max-w-[90vw]",
